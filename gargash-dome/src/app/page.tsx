      ...
      ">
        ...
        ">
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8">
            Agent Gargash is the future of intelligent Agent to Agent and Company to Company communication, 
            designed to reduce solution building within the Gargash Group.
          </p>
...
export default function Home() {
  return (
    <>
      <InteractiveHero 
        brandName="Gargash Dome"
        headline="Unifying Vision Through"
        rotatingTexts={["Intelligence", "Innovation", "Integration", "Insights", "Interaction"]}
        subheadline="A unified AI platform bringing together Gargash Group's companies, enhancing customer touchpoints, and empowering internal teams with data-driven solutions."
        ctaText="Experience Gargash Dome"
