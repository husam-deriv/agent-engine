...
import { FileTextIcon, DatabaseIcon, MessageSquareIcon, BarChartIcon, FileSpreadsheetIcon } from 'lucide-react'
        ...
        <section className="bg-zinc-50 py-16 md:py-24 dark:bg-transparent">
            <div className="mx-auto max-w-3xl lg:max-w-5xl px-6">
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-bold mb-3">Intelligent Document Processing</h1>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                        Upload your documents to create a RAG corpus or analyze data files for AI-powered insights and analysis.
                    </p>
                </div>
                ...
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold">RAG</span>
                                </div>
                                <h2 className="mt-6 text-center text-2xl font-semibold">Retrieval Augmented Generation</h2>
                                <p className="mt-2 text-center text-muted-foreground">Upload documents to create a knowledge base for your AI agents</p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <DatabaseIcon className="m-auto h-16 w-16 text-primary" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition dark:text-white">Data Analysis</h2>
                                    <p className="text-foreground">Upload CSV files to perform advanced data analysis with AI agents that can interpret and visualize your data.</p>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <MessageSquareIcon className="m-auto h-16 w-16 text-primary" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition">Chat with Documents</h2>
                                    <p className="text-foreground">Have natural conversations with your documents and data files for quick insights and information retrieval.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <FileTextIcon className="m-auto size-5" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Multiple Document Types</h2>
                                        <p className="text-foreground">Support for PDFs, DOC, DOCX, XLS, XLSX, PPT, PPTX, TXT, and CSV files for comprehensive analysis.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <BarChartIcon className="m-auto size-6" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition">AI-Powered Analytics</h2>
                                        <p className="text-foreground">Let AI agents interpret your data, generate visualizations, and provide valuable insights for better decision making.</p>
                                    </div>
                                </div>
                                    ...
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="flex flex-col">
                                                ...
                                                <span className="text-xs text-muted-foreground">CSV & Spreadsheet</span>
                                            </span>
                                        </div>
                                        ...
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="flex flex-col items-end">
                                                ...
                                                <span className="text-xs text-muted-foreground">Knowledge Extraction</span>
                                            </span>
                                            <div className="h-16 w-16 flex items-center justify-center bg-primary/10 rounded-lg">
