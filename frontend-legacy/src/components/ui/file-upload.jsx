  ...
  return (
    (<div className="w-full max-w-3xl mx-auto p-4 md:p-6">
      ...
      <motion.div
        ...
        initial={false}
        animate={{
          borderColor: isDragging ? "#b22036" : "#ffffff10",
        ...
        <div className="flex flex-col items-center gap-5">
          <motion.div
            ...
            <UploadCloud
              className={clsx("w-16 h-16 md:w-20 md:h-20 drop-shadow-sm", isDragging
                ? "text-primary"
                : "text-zinc-700 dark:text-zinc-300 group-hover:text-primary transition-colors duration-300")} />
          </motion.div>
 
          <div className="space-y-2">
            <h3
              className="text-xl md:text-2xl font-semibold text-zinc-800 dark:text-zinc-100">
              {isDragging
                ? "Drop files here"
                : files.length
                  ? "Add more files"
      ...
      <div className="mt-8">
        <AnimatePresence>
          {files.length > 0 && (
            <motion.div
              ...
              <h3
                className="font-semibold text-lg md:text-xl text-zinc-800 dark:text-zinc-200">
        ...
        <div
          className={clsx("flex flex-col gap-3 overflow-y-auto pr-2", files.length > 3 &&
                ...
                <div className="relative flex-shrink-0">
                  {file.type.startsWith("image/") ? (
                    ...
                    <video
                      ...
                      playsInline
                      preload="metadata"
                      // You can add a preview frame if needed
                      poster="" />
                  ) : (
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col gap-1 w-full">
                    ...
                    <div className="flex items-center gap-2 min-w-0">
                      <FileIcon className="w-5 h-5 flex-shrink-0 text-primary dark:text-primary-400" />
                      <h4
                    ...
                    <div
                      className="flex items-center justify-between gap-3 text-sm text-zinc-500 dark:text-zinc-400">
                  ...
                  {/* Progress bar */}
                  <div
                    className="w-full h-2 bg-zinc-200 dark:bg-zinc-700 rounded-full overflow-hidden mt-3">
                    <motion.div
                      initial={{ width: 0 }}
