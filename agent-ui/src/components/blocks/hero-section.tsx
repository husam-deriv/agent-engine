...
const NavLink: React.FC<NavLinkProps> = ({ href = "#", children, hasDropdown = false, className = "", onClick }) => (
   ...
   >
     ...
     {!hasDropdown && (
         <motion.div
           className="absolute bottom-[-2px] left-0 right-0 h-[1px] bg-[#f60021]"
...
const InteractiveHero: React.FC<InteractiveHeroProps> = ({
  ...
  headline = "Deliver collaborative",
  rotatingTexts = ['Support', 'Experiences', 'Relationships', 'Help', 'Service'],
  ...
  ctaText = "See Agent Engine in action",
  announcementText = "Announcing our $15M Series A"
}) => {
    ...
    <div className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
            ...
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 2L2 7L12 12L22 7L12 2Z" stroke="#f60021" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M2 17L12 22L22 17" stroke="#f60021" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M2 12L12 17L22 12" stroke="#f60021" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <span className="text-xl font-bold text-white ml-2">{brandName}</span>
                </div>
                ...
                <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
                    ...
                    <a
                        href="/onboarding"
                        className="bg-[#f60021] text-white px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
                    >
                        Create New Project
                    </a>
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <ShinyText text={announcementText} className="bg-[#1a1a1a] border border-gray-700 text-[#f60021] px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-[#f60021]/50 transition-colors" />
            </motion.div>
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={rotatingTexts}
                        mainClassName="text-[#f60021] mx-1"
                        staggerFrom={"last"}
                        initial={{ y: "-100%", opacity: 0 }}
                        animate={{ y: 0, opacity: 1 }}
            ...
            >
                <input
                    ...
                    className="flex-grow w-full sm:w-auto px-4 py-2 rounded-md bg-[#2a2a2a] border border-gray-700 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#f60021] focus:border-transparent transition-all"
                />
                <motion.button
                    type="submit"
                    className="w-full sm:w-auto bg-[#f60021] text-white px-5 py-2 rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
            ...
            >
                For the internal teams @Gargash Group
            </motion.p>
